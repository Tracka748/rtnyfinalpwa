...
export default function CheckoutPage() {
  ...
  const handlePayment = async () => {
    ...
    try {
      // Prepare request data for purchase API
      const purchaseData = {
      ...
      // Success: save order details and redirect
      const orderDetails = {
      ...
      sessionStorage.setItem('completed_order', JSON.stringify(orderDetails))
      sessionStorage.removeItem('checkout_cart')

      router.push(`/confirmation?orderId=${data.order_id}&success=true`)
